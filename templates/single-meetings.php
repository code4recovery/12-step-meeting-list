	...
	<div class="row">
		<div class="col-md-10 col-md-offset-1 main">
			...
			<div class="page-header">
				...
				<?php echo tsml_link(get_post_type_archive_link('meetings'), '<i class="glyphicon glyphicon-chevron-right"></i> ' . __('Back to Meetings', 'tsml'), 'meetings')?>
			</div>
					...
					<script>
						...
						google.maps.event.addDomListener(window, 'load', function() {
							...
							var contentString = '<div class="infowindow">'+
								...
								'<p><a class="btn btn-default" href="http://maps.apple.com/?q=<?php echo urlencode($meeting->formatted_address)?>"><?php _e('Directions', 'tsml')?></a></p>' +
								'</div>';
