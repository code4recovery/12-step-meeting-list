                                    ...
                                    if (!empty($meeting->data_source)) {
                                        if (!empty($meeting->entity) || !empty($meeting->entity_url)) {
                                            ...
                                            if (!empty($meeting->entity_phone)) {
                                                ?>
                                                <a class="tsml-button-link meeting-entity-phone" href="sms:<?php echo esc_attr($meeting->entity_phone); ?>">
                                            ...
                                            if (!empty($meeting->entity_url)) {
                                                ?>
                                                <a class="tsml-button-link meeting-entity-phone" href="<?php echo esc_attr($meeting->entity_url); ?>">
                                                    <svg class="icon" viewBox="0 0 16 16"
                                                        fill="currentColor" xmlns="http://www.w3.org/2000/svg">
