...
jQuery(function($) {
    ...
    if (tsml.debug)
      console.log("tsml strings: ", tsml.strings);
	...
	function sanitizeDataSort(str) {
		...
		var e = document.createElement('textarea'); e.innerHTML = str; str = e.value;
  ...
  $.widget("custom.searchComplete", $.ui.autocomplete, {
    ...
    _renderMenu: function (ul, items) {
      ...
      $.each(items, function (index, item) {
        ...
        if (item.type != currentType) {
          ...
          console.log("Key/string values: ", key, tsml.strings);
    ...
    $.when(
      ...
      $('#meetings #search input[name="query"]').searchComplete({
        // classes: {
