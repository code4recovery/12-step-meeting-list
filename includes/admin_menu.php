...
add_action('admin_menu', function () {
    ...
    if (TSML_ADMIN) {
        add_submenu_page('edit.php?post_type=tsml_meeting', __('Geocoding', '12-step-meeting-list'), __('Geocoding', '12-step-meeting-list'), 'manage_options', 'geocoding', 'tsml_geocoding_page');
    }
