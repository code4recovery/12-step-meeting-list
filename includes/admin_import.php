				...
				<div id="postbox-container-1" class="postbox-container">
					...
					<div class="postbox" id="wheres_my_info">
						<div class="inside">
							...
							<p><?php printf(__('A very basic PDF schedule is available in three sizes: <a href="%s">4x7</a>, <a href="%s">half page</a> and <a href="%s">full page</a>.', '12-step-meeting-list'), admin_url('admin-ajax.php') . '?action=tsml_pdf&width=4&height=7', admin_url('admin-ajax.php') . '?action=tsml_pdf', admin_url('admin-ajax.php') . '?action=tsml_pdf&width=8.5')?></p>
							<?php }?>
