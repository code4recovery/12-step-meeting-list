...
if (!function_exists('tsml_import_page')) {
	...
	{
		global $tsml_data_sources, $tsml_programs, $tsml_program, $tsml_nonce, $tsml_sharing, $tsml_google_maps_key, $tsml_mapbox_key,
			$tsml_slug, $tsml_change_detect;
			...
			<?php if (empty($tsml_mapbox_key) && empty($tsml_google_maps_key)) { ?>
				<div class="notice notice-warning">
					...
					<p>Be sure to:<br>
						...
						<span class="dashicons dashicons-yes"></span> Enable the Geocoding API
					</p>
