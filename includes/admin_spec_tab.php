	...
	<div class="postbox">
		<div class="inside">
			...
			<ul class="ul-disc">
				...
				<li><?php _e('<strong>Venmo</strong> is an optional string and should be a valid Venmo handle, (e.g. @AAGroupName). This is understood to be the address for 7th Tradition contributions to the meeting, and not any other entity.', '12-step-meeting-list') ?></li>
				<li><?php _e('<strong>Square</strong> is an optional string and should be a valid Square Cash App cashtag, (e.g. $AAGroupName). This is understood to be the address for 7th Tradition contributions to the meeting, and not any other entity.', '12-step-meeting-list') ?></li>
				<li><?php _e('<strong>PayPal</strong> is an optional string and should be a valid PayPal username, (e.g. AAGroupName). This is understood to be the address for 7th Tradition contributions to the meeting, and not any other entity.', '12-step-meeting-list') ?></li>
				...
				<li><?php _e('<strong>Feedback URL</strong> is an optional string URL that can be used to provide feedback about the meeting. These could be local links (e.g. /feedback?meeting=meeting-slug-1), remote links (e.g. https://typeform.com/to/23904203?meeting=meeting-slug-1), or email links (e.g. mailto:webservant@domain.org?subject=meeting-slug-1).', '12-step-meeting-list') ?></li>
