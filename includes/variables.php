...
if (!$tsml_google_maps_key = get_option('tsml_google_maps_key')) {
	...
	if (in_array($host, array(
		...
		'aamonterey.org', 'aanapa.org', 'aanaples.org',
		...
		'arkansascentraloffice.org', 'austinaa.org', 'bowlinggreenaa.org', 'cbiaa.org', 'centexintergroup.com', 'cflintergroup.org', 
		'charlotteaa.org',
		...
		'nm-aa.org', 'nosdco-aa.org', 'oahucentraloffice.com', 'puebloaa.org', 'readingberksintergroup.org', 
