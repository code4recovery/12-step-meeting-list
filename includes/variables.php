    ...
    $tsml_programs = [
        ...
        'ma' => [
            ...
            'types' => [
                ...
                'Beginners' => __('Beginners', '12-step-meeting-list'),
                'Book Study' => __('Book Study', '12-step-meeting-list'),
                'Business' => __('Business', '12-step-meeting-list'),
                'Candlelight' => __('Candlelight', '12-step-meeting-list'),
                'Chip' => __('Chip', '12-step-meeting-list'),
                'Closed' => __('Closed', '12-step-meeting-list'),
                'Closed Captions' => __('Closed Captions', '12-step-meeting-list'),
                'Daily' => __('Daily', '12-step-meeting-list'),
                'Danish' => __('Danish', '12-step-meeting-list'),
                'Discussion' => __('Discussion', '12-step-meeting-list'),
                'Dutch, Flemish' => __('Dutch, Flemish', '12-step-meeting-list'),
                'English' => __('English', '12-step-meeting-list'),
                'Finnish' => __('Finnish', '12-step-meeting-list'),
                'Friday' => __('Friday', '12-step-meeting-list'),
                'French' => __('French', '12-step-meeting-list'),
                'Icelandic' => __('Icelandic', '12-step-meeting-list'),
                'Italian' => __('Italian', '12-step-meeting-list'),
                'Japanese' => __('Japanese', '12-step-meeting-list'),
                'Land' => __('Land', '12-step-meeting-list'),
                'LGBTQI+' => __('LGBTQI+', '12-step-meeting-list'),
                'Meditation' => __('Meditation', '12-step-meeting-list'),
                'Men' => __('Men', '12-step-meeting-list'),
                'Monday' => __('Monday', '12-step-meeting-list'),
                'Monthly' => __('Monthly', '12-step-meeting-list'),
                'New' => __('New', '12-step-meeting-list'),
                'Non-binary' => __('Non-binary', '12-step-meeting-list'),
                'Online' => __('Online', '12-step-meeting-list'),
                'Online-Show City' => __('Online-Show City', '12-step-meeting-list'),
                'Open' => __('Open', '12-step-meeting-list'),
                'Outdoor' => __('Outdoor', '12-step-meeting-list'),
                'Persian' => __('Persian', '12-step-meeting-list'),
                'Persons of Color' => __('Persons of Color', '12-step-meeting-list'),
                'Phone' => __('Phone', '12-step-meeting-list'),
                'Polish' => __('Polish', '12-step-meeting-list'),
                'Portuguese' => __('Portuguese', '12-step-meeting-list'),
                'Saturday' => __('Saturday', '12-step-meeting-list'),
                'Speaker' => __('Speaker', '12-step-meeting-list'),
                'Spanish, Castilian' => __('Spanish, Castilian', '12-step-meeting-list'),
                'Sunday' => __('Sunday', '12-step-meeting-list'),
                'Thursday' => __('Thursday', '12-step-meeting-list'),
                'Tuesday' => __('Tuesday', '12-step-meeting-list'),
                'Transgender' => __('Transgender', '12-step-meeting-list'),
                'Wednesday' => __('Wednesday', '12-step-meeting-list'),
                'Weekly' => __('Weekly', '12-step-meeting-list'),
                'Wheelchair Accessible' => __('Wheelchair Accessible', '12-step-meeting-list'),
                'Women' => __('Women', '12-step-meeting-list'),
                'Young People' => __('Young People', '12-step-meeting-list'),
            ],
        ],
        'na' => [
